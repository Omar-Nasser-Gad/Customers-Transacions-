...
$(document).ready(function () {
    ...
    let transactionChartCtx = document.getElementById('transactionGraph').getContext('2d');
    let transactions = [];
    let customers = [];
    let transactionGraph;

    // Add data from the JSON server
    ...
    function displayChart(transactions) {
        ...
        transactionGraph = new Chart(transactionChartCtx, {
            type: 'bar',
            data: {
                labels: labels,
                datasets: [{
